	...
	return (
		<div className='w-full flex flex-col gap-4'>
			...
			<div className='flex w-full gap-10'>
				...
				<div
					ref={scrollRef}
					className='flex w-[55%] gap-10 overflow-x-hidden scroll-smooth'
				>
					{[...Array(6)].map((_, i) => (
						<motion.div
							key={i}
							className='flex flex-col items-center justify-center gap-3 min-w-[218px]'
							initial={{ opacity: 0, y: 20 }}
							animate={{ opacity: 1, y: 0 }}
							transition={{ duration: 0.5, delay: i * 0.1 }}
						>
