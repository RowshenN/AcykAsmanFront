	...
	return (
		...
		>
			<div className='flex xs:w-full md:w-[50%] items-center justify-start gap-[22px]'>
				<div className='border xs:min-w-[150px] md:max-w-[334px] border-border dark:border-borderDark rounded-[20px] w-full xs:min-h-[150px] md:max-h-[296px] h-full overflow-hidden'>
